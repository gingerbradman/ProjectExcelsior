...
public class Inspect_Trap_Trigger_script : NetworkBehaviour
{
    ...
    private void OnTriggerEnter(Collider other) 
    {
        if(other.tag == "ActivePlayer"){
            ...
            if(otherRole.currentNetworkRole.Value == (int)Role_script.role.Skeptic)
            {
                // Allow the Skeptic to determine if the trap is armed.
            }
